...
import { T as Tabs, b as TabsList, c as TabsTrigger, a as TabsContent } from "./tabs-Ac6fMhVb.js";
import { S as Select, c as SelectTrigger, d as SelectValue, a as SelectContent, b as SelectItem } from "./select-PuHgjNVl.js";
import { u as useAuth, l as localIsoDate, s as supabase, t as toast } from "./router-Qm6JXj-0.js";
import { c as createLucideIcon } from "./wallet-DqkLRMIT.js";
import { C as Calendar } from "./calendar-CJGTkb1a.js";
import { D as DollarSign } from "./dollar-sign-Bv_oneof.js";
import { T as TrendingUp } from "./trending-up-D8pcVgK6.js";
import "node:events";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./index-JE3_cj3T.js";
import "./index-DXoOElG1.js";
import "./index-1RdIJk7-.js";
import "./Combination-B5T-0ziG.js";
...
const getMovementColor = (type, subtype) => {
...
const getMovementLabel = (type, subtype) => {
...
function DailyMovementsPage() {
  ...
  const [selectedAdvisor, setSelectedAdvisor] = reactExports.useState("all");
  ...
  const loadMovements = async () => {
    ...
    try {
      ...
      const profilesMap = Object.fromEntries((profs ?? []).map((p) => [p.id, p.full_name]));
      const {
        data: clients
      } = await supabase.from("clients").select("id, full_name, cedula");
      const clientsMap = Object.fromEntries((clients ?? []).map((c) => [c.id, {
        full_name: c.full_name,
        cedula: c.cedula
      }]));
      let pq = supabase.from("payments").select("id, loan_id, client_id, advisor_id, payment_type, amount, payment_date, notes, created_at").eq("payment_date", date).order("created_at", {
        ascending: false
      });
      ...
      let lq = supabase.from("loans").select("id, amount, loan_date, created_by, client_id, renewed_from, created_at").eq("loan_date", date).order("created_at", {
        ascending: false
      });
      if (selectedAdvisor !== "all") {
      ...
      const newLoanClientIds = Array.from(new Set((loans ?? []).filter((l) => !l.renewed_from).map((l) => l.client_id)));
      ...
      let nq = supabase.from("change_requests").select("id, request_type, client_id, payload, reviewed_at, requested_by, created_at").eq("status", "approved").gte("reviewed_at", dayStart).lte("reviewed_at", dayEnd).order("reviewed_at", {
        ascending: false
      });
      if (selectedAdvisor !== "all") {
      ...
      (novelties ?? []).forEach((n) => {
        ...
        allMovements.push({
          ...
          client_name: n.client_id ? clientsMap[n.client_id]?.full_name : void 0,
          client_cedula: n.client_id ? clientsMap[n.client_id]?.cedula : void 0,
      ...
      let cq = supabase.from("clients").select("id, full_name, cedula, created_by, created_at").gte("created_at", todayStart).lte("created_at", todayEnd).order("created_at", {
        ascending: false
      });
      if (selectedAdvisor !== "all") {
      ...
      (transfers ?? []).forEach((t) => {
        const shouldShow = role === "admin" ? selectedAdvisor === "all" || selectedAdvisor === t.from_advisor || selectedAdvisor === t.to_advisor : t.from_advisor === user?.id || t.to_advisor === user?.id;
        if (shouldShow) {
          allMovements.push({
            id: `transfer-${t.id}`,
            type: "transfer",
  ...
  const exportToExcel = () => {
    ...
    const fileName = `movimientos_${date}_${(/* @__PURE__ */ new Date()).getTime()}.xlsx`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mb-6 flex flex-wrap items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "Movimientos del día" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: role === "admin" ? "Actividad de todos los asesores" : "Actividad propia" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: exportToExcel, disabled: movements.length === 0, variant: "outline", size: "sm", className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Pagos" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold", children: totals.paymentCount }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-green-600 mt-1", children: fmt(totals.paymentTotal) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { className: "h-8 w-8 text-green-500 opacity-20" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Préstamos" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold", children: totals.loanCount }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-blue-600 mt-1", children: fmt(totals.loanTotal) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-8 w-8 text-blue-500 opacity-20" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Novedades" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold", children: totals.noveltyCount })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-8 w-8 text-yellow-500 opacity-20" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Clientes nuevos" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold", children: totals.clientCount })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-8 w-8 text-purple-500 opacity-20" })
      ] }) })
    ] }),
    role === "admin" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-muted-foreground", children: "Filtrar por asesor:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: selectedAdvisor, onValueChange: setSelectedAdvisor, children: [
    ...
    ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Mostrando solo tu actividad." }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "all", className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid w-full grid-cols-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "payment", children: [
          "Pagos",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-xs", children: [
            "(",
            totals.paymentCount,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "loan", children: [
          "Préstamos",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-xs", children: [
            "(",
            totals.loanCount,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "novelty", children: [
          "Novedades",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-xs", children: [
            "(",
            totals.noveltyCount,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "client", children: [
          "Clientes",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-xs", children: [
            "(",
            totals.clientCount,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "transfer", children: [
          "Transferencias",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-xs", children: [
            "(",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "all", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovementsList, { movements, loading: loadingData, dateLabel }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "payment", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovementsList, { movements: byType.payment, loading: loadingData, dateLabel }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "loan", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovementsList, { movements: byType.loan, loading: loadingData, dateLabel }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "novelty", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovementsList, { movements: byType.novelty, loading: loadingData, dateLabel }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "client", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovementsList, { movements: byType.client, loading: loadingData, dateLabel }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "transfer", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MovementsList, { movements: byType.transfer, loading: loadingData, dateLabel }) })
    ] })
  ] });
}
function MovementsList({
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Cargando movimientos..." }) });
  }
  if (!movements.length) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Sin movimientos en esta fecha" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: movements.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: `p-4 border-l-4 ${getMovementColor(m.type, m.subtype)}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl", children: getMovementIcon(m.type) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: m.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: getMovementLabel(m.type, m.subtype) }),
          m.transfer_status && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: m.transfer_status === "approved" ? "default" : m.transfer_status === "pending" ? "outline" : "destructive", className: "text-xs", children: m.transfer_status === "approved" ? "Aprobada" : m.transfer_status === "pending" ? "Pendiente" : "Rechazada" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground space-y-1", children: [
          m.type === "transfer" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "De:" }),
              " ",
              m.from_advisor_name || m.advisor_name || m.advisor_id
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Para:" }),
              " ",
              m.to_advisor_name || "—"
            ] })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Asesor:" }),
            " ",
            m.advisor_name || m.advisor_id
          ] }),
          m.client_name && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Cliente:" }),
            " ",
            m.client_name,
            " ",
            m.client_cedula && `(${m.client_cedula})`
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: new Date(m.timestamp).toLocaleTimeString("es-CO", {
            hour: "2-digit",
            minute: "2-digit",
            second: "2-digit"
          }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
      m.amount !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold text-green-600", children: fmt(m.amount) }),
      m.details?.notes && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2 max-w-xs", children: m.details.notes })
    ] })
  ] }) }, m.id)) });
}
export {
  DailyMovementsPage as component
};
