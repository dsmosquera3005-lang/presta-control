...
import { f as useParams, u as useAuth } from "./router-Qm6JXj-0.js";
...
const fetchReceiptData = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).inputValidator((data) => data).handler(createSsrRpc("56d06d808f618ec68a19f6603fa4eb5bb73c25b7a68af3de013911dba9a9d06d"));
