import { T as reactExports, K as jsxRuntimeExports, R as React } from "./worker-entry-CNURiMmK.js";
import { A as AppLayout } from "./AppLayout-PvnASmSl.js";
import { u as useAuth, e as useChatNotifications, s as supabase, t as toast } from "./router-D6fjANqK.js";
import { d as createLucideIcon, u as useComposedRefs, a as cn, b as composeRefs, B as Button$1 } from "./button-Ch56ZDAM.js";
import { I as Input } from "./input-B7Qm_XgT.js";
import { f as useDirection, P as Primitive, b as createContextScope, c as composeEventHandlers, u as useCallbackRef, h as useLayoutEffect2, e as useControllableState, g as useId } from "./index-11z5DbUg.js";
import { P as Presence } from "./index-DzDdKfKp.js";
import { c as clamp, b as Root2$1, A as Anchor, d as createPopperScope, P as Portal$1, h as hideOthers, R as ReactRemoveScroll, u as useFocusGuards, F as FocusScope, D as DismissableLayer, C as Content, a as Arrow } from "./Combination-CmTRIBKz.js";
import { P as Plus$1 } from "./plus-DR4_vM0_.js";
import { F as FileText } from "./file-text-0bM4kPD-.js";
import { S as Send } from "./send-CwCvBHT-.js";
import "node:events";
...
var PickerDataContext = /* @__PURE__ */ React.createContext({
  emojiData: {},
  allEmojis: [],
  allEmojisByUnified: {},
  searchIndex: {},
...
function PickerDataProvider(_ref) {
  ...
  var emojiByUnified2 = React.useCallback(function(unified) {
  ...
  return React.createElement(PickerDataContext.Provider, {
    value: _extends({}, data, {
...
function ChatPage() {
  ...
  async function loadConversations() {
    ...
    const {
      data: convs
    } = await supabase.from("conversations").select("id, type, name").in("id", ids);
    const list = convs ?? [];
    for (const c of list) {
      if (c.type === "direct") {
        const {
          data: others
        } = await supabase.from("conversation_participants").select("user_id").eq("conversation_id", c.id).neq("user_id", user.id);
  ...
  reactExports.useEffect(() => {
    ...
    const channel = supabase.channel(`messages-${activeConv.id}`).on("postgres_changes", {
      ...
      const {
        data: p
      } = await supabase.from("profiles").select("full_name").eq("id", m.sender_id).maybeSingle();
  ...
  async function startDirectChat(otherId) {
    ...
    if (myIds.length) {
      const {
        data: shared
      } = await supabase.from("conversation_participants").select("conversation_id, conversations!inner(type)").eq("user_id", otherId).in("conversation_id", myIds);
      const direct = (shared ?? []).find((s) => s.conversations?.type === "direct");
      if (direct) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-[calc(100vh-8rem)] md:h-[calc(100vh-4rem)] gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-72 flex flex-col border rounded-lg bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border-b flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold", children: "Conversaciones" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "sm", variant: "ghost", onClick: () => setShowNew((v) => !v), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus$1, { className: "h-4 w-4" }) })
      ] }),
      showNew && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 border-b max-h-60 overflow-y-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground px-2 py-1", children: "Nuevo chat con:" }),
        profiles.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => startDirectChat(p.id), className: "w-full text-left px-3 py-2 text-sm hover:bg-accent rounded", children: p.full_name }, p.id))
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1", children: conversations.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveConv(c), className: cn("w-full text-left px-3 py-3 border-b text-sm hover:bg-accent", activeConv?.id === c.id && "bg-accent"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-medium flex items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: c.type === "group" ? `# ${c.name ?? "Grupo"}` : c.other_name ?? "Chat" }),
          (unreadByConv[c.id] ?? 0) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-destructive px-1.5 text-xs font-semibold text-destructive-foreground", children: unreadByConv[c.id] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: c.type === "group" ? "Grupo" : "Directo" })
      ] }, c.id)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col border rounded-lg bg-card", children: !activeConv ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center text-muted-foreground", children: "Selecciona una conversación" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-b", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold", children: activeConv.type === "group" ? `# ${activeConv.name}` : activeConv.other_name }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: scrollRef, className: "flex-1 overflow-y-auto p-4 space-y-3", children: messages.map((m) => {
        const mine = m.sender_id === user?.id;
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("flex", mine ? "justify-end" : "justify-start"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("max-w-[75%] rounded-lg px-3 py-2 text-sm", mine ? "bg-primary text-primary-foreground" : "bg-muted"), children: [
          !mine && activeConv.type === "group" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold mb-1 opacity-80", children: m.sender_name }),
          m.message_type === "text" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whitespace-pre-wrap break-words", children: m.content }),
          m.message_type === "image" && m.file_url && /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: m.file_url, target: "_blank", rel: "noreferrer", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: m.file_url, alt: m.file_name ?? "", className: "rounded max-w-xs" }) }),
          m.message_type === "document" && m.file_url && /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: m.file_url, target: "_blank", rel: "noreferrer", className: "flex items-center gap-2 underline", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-4 w-4" }),
            " ",
            m.file_name
          ] }),
          m.message_type === "audio" && m.file_url && /* @__PURE__ */ jsxRuntimeExports.jsx("audio", { controls: true, src: m.file_url, className: "max-w-xs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] opacity-60 mt-1 text-right", children: new Date(m.created_at).toLocaleTimeString([], {
            hour: "2-digit",
            minute: "2-digit"
          }) })
        ] }) }, m.id);
      }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border-t flex items-end gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "icon", variant: "ghost", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Smile, { className: "h-4 w-4" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverContent, { className: "w-auto p-0", side: "top", align: "start", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmojiPicker$1, { onEmojiClick: (e) => setInput((v) => v + e.emoji) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "cursor-pointer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "file", accept: "image/*", className: "hidden", onChange: (e) => e.target.files?.[0] && uploadAndSend(e.target.files[0], "image") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "icon", variant: "ghost", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image$1, { className: "h-4 w-4" }) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "cursor-pointer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "file", className: "hidden", onChange: (e) => e.target.files?.[0] && uploadAndSend(e.target.files[0], "document") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "icon", variant: "ghost", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Paperclip, { className: "h-4 w-4" }) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "icon", variant: recording ? "destructive" : "ghost", onClick: recording ? stopRecording : startRecording, children: recording ? /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "h-4 w-4" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: input, onChange: (e) => setInput(e.target.value), onKeyDown: (e) => {
          if (e.key === "Enter" && !e.shiftKey) {
            e.preventDefault();
            void sendText();
          }
        }, placeholder: "Escribe un mensaje...", className: "flex-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "icon", onClick: () => void sendText(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "h-4 w-4" }) })
      ] })
    ] }) })
  ] }) });
}
