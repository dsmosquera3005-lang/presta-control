import { e as commonjsGlobal, x as getDefaultExportFromCjs, T as reactExports, R as React, K as jsxRuntimeExports } from "./worker-entry-CNURiMmK.js";
import { A as AppLayout, B as Banknote, U as Users } from "./AppLayout-PvnASmSl.js";
import { C as Card } from "./card-DGzOhCrx.js";
import { u as useAuth, s as supabase } from "./router-D6fjANqK.js";
import { B as Badge } from "./badge-DyNApPR-.js";
import { c as clsx, e as createSlot, a as cn } from "./button-Ch56ZDAM.js";
import { T as TriangleAlert } from "./triangle-alert-u3CMBRF5.js";
import { T as TrendingUp } from "./trending-up--iuEuUwV.js";
import "node:events";
...
function DashboardPage() {
  ...
  const loadStats = async () => {
    ...
    let loansQ = supabase.from("loans").select("amount, expected_amount, payment_date, status, loan_date");
    let clientsQ = supabase.from("clients").select("id, status");
    let upcomingQ = supabase.from("loans").select("id, expected_amount, payment_date, clients(full_name, cedula)").eq("status", "activo").gte("payment_date", (/* @__PURE__ */ new Date()).toISOString().slice(0, 10)).order("payment_date", {
      ascending: true
    }).limit(5);
    let paymentsQ = supabase.from("payments").select("amount, payment_date, payment_type, advisor_id");
    if (!isAdmin && user) {
    ...
    const totalLoaned = (loans ?? []).filter((l) => l.status !== "pagado").reduce((s2, l) => s2 + Number(l.amount), 0);
    const expectedInterest = (loans ?? []).filter((l) => l.status === "activo").reduce((s2, l) => s2 + Math.max(0, Number(l.expected_amount) - Number(l.amount)), 0);
    const monthStartIso = monthStart.toISOString().slice(0, 10);
    const monthEndIso = monthEnd.toISOString().slice(0, 10);
    const collectedInterest = (payments ?? []).filter((p) => p.payment_type === "interes" && p.payment_date >= monthStartIso && p.payment_date <= monthEndIso).reduce((s2, p) => s2 + Number(p.amount), 0);
    const overdue = (loans ?? []).filter((l) => l.status === "activo" && new Date(l.payment_date) < today).length;
    const monthly = [];
    for (let i = 5; i >= 0; i--) {
      ...
      const prestado = (loans ?? []).filter((l) => {
        const ld = new Date(l.loan_date);
        return ld >= d && ld <= end;
      }).reduce((s2, l) => s2 + Number(l.amount), 0);
      const esperado = (loans ?? []).filter((l) => {
        const pd = new Date(l.payment_date);
        return pd >= d && pd <= end;
      }).reduce((s2, l) => s2 + Number(l.expected_amount), 0);
      monthly.push({
        month: label,
        prestado,
        esperado
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: role === "admin" ? "Vista global del negocio" : "Resumen de tu cartera" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Banknote, { className: "h-5 w-5" }), label: "Total prestado activo", value: stats ? fmt(stats.totalLoaned) : "—", tone: "primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InterestCard, { expected: stats?.expectedInterest ?? 0, collected: stats?.collectedInterest ?? 0, fmt }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-5 w-5" }), label: "Préstamos vencidos", value: stats ? String(stats.overdue) : "—", tone: "warning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-5 w-5" }), label: "Clientes", value: stats ? String(stats.activeClients) : "—", tone: "muted" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-2 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold mb-1", children: "Actividad mensual" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-4", children: "Prestado vs esperado (últimos 6 meses)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: stats?.monthly ?? [], children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.9 0.01 240)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "month", stroke: "oklch(0.5 0.03 240)", fontSize: 12 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(0.5 0.03 240)", fontSize: 12 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
            backgroundColor: "oklch(1 0 0)",
            border: "1px solid oklch(0.9 0.01 240)",
            borderRadius: 8
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "prestado", fill: "oklch(0.45 0.16 155)", radius: [4, 4, 0, 0], name: "Prestado" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "esperado", fill: "oklch(0.62 0.18 155)", radius: [4, 4, 0, 0], name: "Esperado" })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold mb-1", children: "Tendencia de cobros" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-4", children: "Monto esperado por mes" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: stats?.monthly ?? [], children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.9 0.01 240)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "month", stroke: "oklch(0.5 0.03 240)", fontSize: 12 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(0.5 0.03 240)", fontSize: 12 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "esperado", stroke: "oklch(0.45 0.16 155)", strokeWidth: 3, dot: {
            r: 4
          } })
        ] }) }) })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold mb-4", children: "Próximos pagos" }),
      stats?.upcoming.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: stats.upcoming.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 rounded-lg bg-muted/40 border border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: l.clients?.full_name ?? "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground", children: [
            "Cédula ",
            l.clients?.cedula ?? "—",
            " · ",
            new Date(l.payment_date).toLocaleDateString("es")
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "font-semibold", children: fmt(Number(l.expected_amount)) })
      ] }, l.id)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No hay pagos próximos." })
    ] })
  ] });
}
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6 shadow-[var(--shadow-card)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-2 rounded-lg ${tones[tone]}`, children: icon })
    ] }),
...
function InterestCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6 shadow-[var(--shadow-card)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Interés esperado" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-success/15 text-success", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-5 w-5" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold tracking-tight", children: fmt(expected) }),
