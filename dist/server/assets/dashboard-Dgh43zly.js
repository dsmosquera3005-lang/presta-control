import { e as commonjsGlobal, z as getDefaultExportFromCjs, Y as reactExports, R as React, P as jsxRuntimeExports } from "./worker-entry-u5osyKlM.js";
import { A as AppLayout, B as Banknote, U as Users } from "./AppLayout-K_SdKmBk.js";
import { C as Card } from "./card-B7GkNEAy.js";
import { c as clsx, b as cn, u as useAuth, s as supabase, l as localIsoDate } from "./router-Qm6JXj-0.js";
import { B as Badge } from "./badge-D8T-nd2b.js";
import { a as createSlot } from "./button-CBWpG-_X.js";
...
function DashboardPage() {
  ...
  const loadStats = async () => {
    ...
    let upcomingQ = supabase.from("loans").select("id, expected_amount, payment_date, clients(full_name, cedula)").eq("status", "activo").gte("payment_date", localIsoDate()).order("payment_date", {
      ascending: true
    }).limit(5);
