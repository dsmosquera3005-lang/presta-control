import { T as reactExports, K as jsxRuntimeExports } from "./worker-entry-CNURiMmK.js";
import { s as supabase, t as toast, f as useParams, u as useAuth, L as Link } from "./router-D6fjANqK.js";
import { A as AppLayout } from "./AppLayout-PvnASmSl.js";
import { C as Card } from "./card-DGzOhCrx.js";
import { d as createLucideIcon, B as Button, a as cn } from "./button-Ch56ZDAM.js";
...
import { S as Select, c as SelectTrigger, d as SelectValue, a as SelectContent, b as SelectItem } from "./select-D5sEDkdZ.js";
import { P as Phone, c as calcMora, t as totalDue, C as CircleCheck } from "./mora-BGNqXlwZ.js";
import { R as REQUEST_LABELS, c as createChangeRequest } from "./changeRequests-CPczNLc7.js";
import { S as Send } from "./send-CwCvBHT-.js";
import { A as ArrowLeft } from "./arrow-left-BFhWGrEo.js";
import { C as Calendar } from "./calendar-CJGQR6Xx.js";
import { F as FileText } from "./file-text-0bM4kPD-.js";
import { P as Plus } from "./plus-DR4_vM0_.js";
...
import "node:stream";
import "./index-11z5DbUg.js";
import "./Combination-CmTRIBKz.js";
...
function NoveltyDialog({ trigger, defaultType, clientId, loanId, paymentId, clientName, current }) {
  ...
  const submit = async () => {
    ...
    if (type === "delete_payment") {
      ...
      if (p) {
        const { data: pay } = await supabase.from("payments").select("loan_id").eq("id", p.id).maybeSingle();
        let prevDate = null;
